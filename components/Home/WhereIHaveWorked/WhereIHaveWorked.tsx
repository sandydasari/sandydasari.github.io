...
import BAHMNI from "./Descriptions/BAHMNI";
// import AdvancedAgroManagement from "./Descriptions/AdvancedAgroManagement";
import Thoughtworks from "./Descriptions/Thoughtworks";
// import SuperBerry from "./Descriptions/SuperBerry";
import ANZ from "./Descriptions/ANZ";
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("ANZ");
  return (
...
const CompaniesBar = props => {
  ...
  return (
    ...
    >
      {/* // ? left bar Holder */}
      <div
        className=" hidden md:block bg-gray-500 relative h-0.5 w-34 md:h-[110px] translate-y-1 md:w-0.5  
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        ...
        <CompanyButton
          ...
          <CompanyButton
            ...
            BarPosition={76}
            BarAvobePosition={100}
            DescriptionJob="Thoughtworks"
